    ...
    <section className='container-banner' id='home'>
      <div className='grid-container'>
        ...
        <div className='stats'>
          <div className='stat'>
            <h2>+2 milhões</h2>
            <span>de contas economizadas</span>
          </div>
          <div className='stat'>
            <h2>+500</h2>
            <span>usinas instaladas</span>
          </div>
          <div className='stat'>
            <h2>+7</h2>
